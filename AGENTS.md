...
- `docs/skills/use-powershell-safely/STATE.md`: continuation, current candidate,
  writer/delivery boundaries and outstanding decisions.
- `docs/skills/use-powershell-safely/DESIGN.md`: changes to selection, workflow,
...
- `docs/skills/use-powershell-safely/VERIFICATION.md`: checks affected by the change
...
- Select affected SOURCE, metadata or focused checks from
  `docs/skills/use-powershell-safely/VERIFICATION.md`. Complete authorized local

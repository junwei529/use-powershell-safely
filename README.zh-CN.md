...
绑定预期公开仓库、annotated tag、Release 设置、release-note hash、B1 receipt
与未变 package identity；exact [`CHANGELOG.md`](CHANGELOG.md) title/body 仍需在
创建 tag 或 GitHub Release 前完成人工审核。
...
仓库。public-source 候选本身不证明 remote ref、tag、GitHub Release、公开发布、
persistent install、Profile、discovery configuration 或 installed-copy behavior。
